...
func easyjson727fe99aDecodeForumModels(in *jlexer.Lexer, out *Status) {
...
func easyjson727fe99aEncodeForumModels(out *jwriter.Writer, in Status) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Status) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson727fe99aEncodeForumModels(&w, v)
...
func (v *Status) UnmarshalJSON(data []byte) error {
	...
	easyjson727fe99aDecodeForumModels(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Status) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson727fe99aDecodeForumModels(l, v)
}
